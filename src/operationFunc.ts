...
import {getOperationLog} from "./operations/getOperationLog";
...
exports.getReportRecords = authDecorator(getReportRecords, ["ADMIN", "BOOKER"]);
...
exports.getOperationLog = authDecorator(getOperationLog, ["ADMIN"]);
